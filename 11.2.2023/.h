...
class RobotLine : public Robot {
  ...
  public:
    ...
    */
    uint16_t blue(uint8_t deviceNumber = 0) {
      return mrm_col_can->colorGreen(deviceNumber);
    }
    ...
    */
    uint16_t green(uint8_t deviceNumber = 0) {
      return mrm_col_can->colorGreen(deviceNumber);
    }
    ...
    */
    uint16_t orange(uint8_t deviceNumber = 0) {
      return mrm_col_can->colorOrange(deviceNumber);
    }
    ...
    */
    uint16_t red(uint8_t deviceNumber = 0) {
      return mrm_col_can->colorRed(deviceNumber);
    }
    ...
    */
    uint16_t violet(uint8_t deviceNumber = 0) {
      return mrm_col_can->colorViolet(deviceNumber);
    }
    ...
    */
    uint16_t yellow(uint8_t deviceNumber = 0) {
      return mrm_col_can->colorYellow(deviceNumber);
    }
};
...
class ActionMotorShortTest : public ActionBase {
    void perform() {
      ((RobotLine*)_robot)->motorShortTest();
    }
  public:
